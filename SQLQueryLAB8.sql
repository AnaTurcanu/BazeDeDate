...
--a) creare viziune prin Editorul de interogari, exemplul 18 din laboratorul 4
...
VALUES ('Turcanu', 'Ana'); --Viziunea este construita pe baza cheii primare id_student, care nu permite valori nule, de aceea obtinem eroare.

UPDATE dbo.ViewEX6_fromLAB4_forLAB8 
SET Prenume_Student='Cristofor'
WHERE Prenume_Student='Andrei';

DELETE FROM dbo.ViewEX6_fromLAB4_forLAB8
WHERE Prenume_Student='Alexandru'; --Stergerea unui tuplu din viziune, necesita stergerea acestuia din tabelul studenti, pe baza caruia acesta este construit, ceea ce nu este posibil.
...
ORDER BY studenti.studenti_reusita.Nota DESC --synonyms are not accepted in alter view statements
